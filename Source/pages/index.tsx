...
function HomepageHeader() {
	...
	return (
		<header class={styles.heroBanner}>
			<div class="container">
				...
				<p class="hero__subtitle">
					<Translate id="homepage.subtitle.first">
						...
						let's combine these three and challenge ourselves to
						write a JavaScript parser in Rust.
					</Translate>
				</p>
				<p class="hero__subtitle">
					<Translate id="homepage.subtitle.second_1">
						This will be the guide for you if you are interested in
						learning Rust, parsers, or would like to contribute to
					</Translate>
					<span>
						{" "}
						<a
							href="https://github.com/boshen/oxc"
							target="__blank">
							oxc
						</a>
						,{" "}
						...
						or{" "}
						<a href="https://biomejs.dev" target="__blank">
							Biome
						</a>{" "}
					</span>
				...
				<p class="hero__subtitle">
					<Translate id="homepage.subtitle.third">
						The guide will cover all the basic topics of writing a
						JavaScript parser in rust. The tutorials will explain
				...
				<div class={styles.buttons}>
					<Link
						...
						to="/docs/intro">
						<Translate id="homepage.read.guide">
							Read the Guide
						</Translate>
					</Link>
					<Link
